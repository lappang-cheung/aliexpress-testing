...
<template>
  <div id="MainLayout"
    ...
    <div id="TopMenu"
      ...
      <ul class="flex items-center justify-end text-xs text-[#333333] font-light px-2 h-10 bg-[#fafafa]">
        ...
        <li @mouseenter="isAccountMenu =true"
            ...
            :class="{
              'bg-white border z-40 shadow[0_15px_100px_40px_rgba(0,0,0,0.3)' : isAccountMenu,
              'border border-[#fafafa]' : !isAccountMenu
            }">
          <Icon name="ph:user-thin"
                size="17" />
          Account
