...
<template>
  <MainLayout>
    <div id="ShoppingCardPage" class="mt-4 max-w-[1200px] mx-auto px-2">
      ...
      <div v-else
        ...
        <div class="md:w-[65%]">
          ...
          <div id="Items"
               class="bg-white rounded-lg p-4 mt-4 border">
        ...
        <div class="md:w-[35%]">
          <div id="Summary" class="bg-white rounded-lg p-4 border">
          ...
          <div id="PaymentProtection" class="bg-white rounded-lg p-4 mt-4 border">
