  ...
  <MainLayout>
    <div id="CheckoutPage" class="mt-4 max-w-[1200px] mx-auto px-2">
      <div class="md:flex gap-4 justify-between mx-auto w-full">
        ...
        <div class="md:w-[35%]">
          <div id="PlaceOrder" class="bg-white rounded-lg p-4 border">
            ...
            <form @submit.prevent="pay()">
              ...
              <button :disabled="isProcessing"
                ...
                <Icon v-if="isProcessing" name="eos-icons:loading" size="20" class="mr-2" />
                <div v-else>
                  Place order
                </div>
              </button>
          ...
          <div class="bg-white rounded-lg p-4 mt-4 border">
